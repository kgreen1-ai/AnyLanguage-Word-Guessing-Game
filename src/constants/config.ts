export const CONFIG = {
  ...
  language: 'Metotheeneniaatowetaane', // This changes the display name for your language
  wordLength: 15, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'pikwi', // Put your name here so people know who made this game!
